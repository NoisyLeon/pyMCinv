...
# # 
# dset.paraval_arrays(dtype='min', sigma=1)
...
dset.plot_horizontal(depth=4., dtype='min', is_smooth=False, shpfx=None, clabel='Vs (km/s)', cmap='cv', title='4 km', projection='lambert', hillshade=False,\
