...
struct __pyx_vtabstruct_8modparam_isomod {
  ...
  void (*get_vmodel)(struct __pyx_obj_8modparam_isomod *, std::vector<float>  &, std::vector<float>  &, std::vector<float>  &, std::vector<float>  &, std::vector<float>  &, std::vector<float>  &);
